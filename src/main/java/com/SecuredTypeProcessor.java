...
@SupportedAnnotationTypes("com.SecuredType")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class SecuredTypeProcessor extends AbstractProcessor{
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element elem : roundEnv.getElementsAnnotatedWith(SecuredType.class)) {
            SecuredType implementation = elem.getAnnotation(SecuredType.class);
